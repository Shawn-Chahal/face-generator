...
gen_model = tf.keras.models.load_model(os.path.join('objects', 'flickr-faces', f'gen_model_{epoch:03d}.h5'))
...
plt.tight_layout()
plt.savefig(os.path.join('logs', 'testing', f'faces_{epoch:03d}.png'))
...
plt.tight_layout()
plt.savefig(os.path.join('logs', 'testing', f'face-composite_{epoch:03d}.png'))
